...
describe('ERC-8004 Web Extension (ERC8004EXT-WEB)', () => {
  describe('interfaces onchain field (bitmap)', () => {
    ...
    /** Schema: interfaces must be non-negative (spec bitmap is 0ΓÇô7 for three bits). */
  ...
  describe('contractId metadata key', () => {
    ...
    /** Spec: "contractId MUST be immutable after registration" ΓÇö prepareUpdateApp does not accept contractId. */
  ...
  describe('Registration File extensions (image, publisher, summary, traits)', () => {
    ...
    /** Spec: "Max 20 traits, 120 chars total" ΓÇö schema enforces 20; 120 total enforced when refinement is added. */
  ...
  describe('artifacts (did:artifact, type, downloadUrls)', () => {
    ...
    /** Spec: downloadUrls is MUST ΓÇö at least one URL. */
